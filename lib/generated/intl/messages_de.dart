...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(action) =>
      "${Intl.select(action, {'attack': 'Angriff', 'dash': 'Spurt', 'disengage': 'Rückzug', 'hide': 'Verstecken', 'use_an_object': 'Gegenstand benutzen', 'other': 'Fehler'})}";
  ...
  static String m9(light) =>
      "${Intl.select(light, {'bright_light': 'Helles Licht', 'dim_light': 'Dämmriges Licht', 'darkness': 'Dunkelheit', 'other': 'Fehler'})}";
  ...
  static String m28(status) =>
      "${Intl.select(status, {'concentration': 'Konzentration', 'surprised': 'Überrascht', 'other': 'Fehler'})}";

  static String m29(visibility) =>
      "${Intl.select(visibility, {'lightly_obscured': 'Leicht verschleiert', 'heavily_obscured': 'Komplett verschleiert', 'other': 'Fehler'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "bonusAction": m2,
    "characterAddTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "feetForUi": m6,
    "ff2g": MessageLookupByLibrary.simpleMessage("Fateforge: 2. Die Erwachten"),
    ...
    "filterReset": MessageLookupByLibrary.simpleMessage("Filter zurücksetzen"),
    ...
    "mainScreenSettings": MessageLookupByLibrary.simpleMessage("Einstellungen"),
    "mainScreenSpellBooks": MessageLookupByLibrary.simpleMessage("Charaktere"),
    "mainScreenSpellList": MessageLookupByLibrary.simpleMessage("Zauberliste"),
    ...
    "settingsAppVersionLabel": MessageLookupByLibrary.simpleMessage(
      "App-Version",
    ),
    ...
    "settingsDistanceType": MessageLookupByLibrary.simpleMessage(
      "Einheit auswählen",
    ),
    ...
    "spellDetailCastTime": MessageLookupByLibrary.simpleMessage("Zeitaufwand"),
    "spellDetailClasses": MessageLookupByLibrary.simpleMessage("Klassen"),
    "spellDetailComponents": MessageLookupByLibrary.simpleMessage(
      "Komponenten",
    ),
    ...
    "spellDetailDice": m22,
    "spellDetailDie": m23,
    "spellDetailDistance": MessageLookupByLibrary.simpleMessage("Reichweite"),
    "spellDetailDuration": MessageLookupByLibrary.simpleMessage(
      "Wirkungsdauer",
    ),
    ...
    "xge": MessageLookupByLibrary.simpleMessage("Xanathars Ratgeber für Alles"),
