...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(action) =>
      "${Intl.select(action, {'attack': 'Attack', 'dash': 'Dash', 'disengage': 'Disengage', 'hide': 'Hide', 'use_an_object': 'Use an Object', 'other': 'Error'})}";
  ...
  static String m4(cond) =>
      "${Intl.select(cond, {'blinded': 'Blinded', 'charmed': 'Charmed', 'deafened': 'Deafened', 'frightened': 'Frightened', 'grappled': 'Grappled', 'incapacitated': 'Incapacitated', 'invisible': 'Invisible', 'paralyzed': 'Paralyzed', 'petrified': 'Petrified', 'poisoned': 'Poisoned', 'prone': 'Prone', 'restrained': 'Restrained', 'stunned': 'Stunned', 'unconscious': 'Unconscious', 'exhaustion': 'Exhaustion', 'other': 'Error'})}";

  static String m5(cover) =>
      "${Intl.select(cover, {'half_cover': 'half cover', 'three_quarters_cover': 'three-quarters cover', 'total_cover': 'total cover', 'other': 'Error'})}";
  ...
  static String m9(light) =>
      "${Intl.select(light, {'bright_light': 'bright light', 'dim_light': 'dim light', 'darkness': 'darkness', 'other': 'Error'})}";
  ...
  static String m14(count) =>
      "${Intl.plural(count, one: '1 Round', other: '${count} Rounds')}";

  static String m15(count) =>
      "${Intl.plural(count, one: '1 Second', other: '${count} Seconds')}";

  static String m16(sense) =>
      "${Intl.select(sense, {'darkvision': 'Darkvision', 'truesight': 'Truesight', 'blindsight': 'Blindsight', 'other': 'Error'})}";

  static String m17(lang) =>
      "${Intl.select(lang, {'en': 'English', 'de': 'German', 'other': 'Error'})}";

  static String m18(skill) =>
      "${Intl.select(skill, {'athletics': 'Athletics', 'acrobatics': 'Acrobatics', 'sleight_of_hand': 'Sleight of Hand', 'stealth': 'Stealth', 'arcana': 'Arcana', 'history': 'History', 'investigation': 'Investigation', 'nature': 'Nature', 'religion': 'Religion', 'animal_handling': 'Animal Handling', 'insight': 'Insight', 'medicine': 'Medicine', 'perception': 'Perception', 'survival': 'Survival', 'deception': 'Deception', 'intimidation': 'Intimidation', 'performance': 'Performance', 'persuasion': 'Persuasion', 'other': 'Error'})}";

  static String m19(selectSpecies) =>
      "${Intl.select(selectSpecies, {'half_elf': 'Halfelf', 'half_orc': 'Halforc', 'dragonborn': 'Dragonborn', 'human': 'Human', 'tiefling': 'Tiefling', 'dwarf': 'Dwarf', 'dwarf_hill': 'Hilldwarf', 'dwarf_mountain': 'Mountaindwarf', 'elf': 'Elf', 'elf_drow': 'Drow', 'elf_high': 'Highelf', 'elf_wood': 'Woodelf', 'halfling': 'Halfling', 'halfling_stout': 'Stout Halfling', 'halfling_lightfoot': 'Lightfood Halfling', 'aasimar': 'Aasimar', 'gnome': 'Gnome', 'gnome_forest': 'Forest-Gnome', 'gnome_rock': 'Rock-Gnome', 'goliath': 'Goliath', 'orc': 'Orc', 'aarakocra': 'Aarakocra', 'air_genasi': 'Air Genasi', 'bugbear': 'Bugbear', 'centaur': 'Centaur', 'changeling': 'Changeling', 'deep_gnome': 'Deep Gnome', 'duergar': 'Duergar', 'earth_genasi': 'Earth Genasi', 'eladrin': 'Eladrin', 'fairy': 'Fairy', 'firbolg': 'Firbolg', 'fire_genasi': 'Fire Genasi', 'githyanki': 'Githyanki', 'githzerai': 'Githzerai', 'goblin': 'Goblin', 'harengon': 'Harengon', 'hobgoblin': 'Hobgoblin', 'kenku': 'Kenku', 'kobold': 'Kobold', 'lizardfolk': 'Lizardfolk', 'minotaur': 'Minotaur', 'satyr': 'Satyr', 'sea_elf': 'Sea Elf', 'shadar_kai': 'Shadar-kai', 'shifter': 'Shifter', 'tabaxi': 'Tabaxi', 'tortle': 'Tortle', 'triton': 'Triton', 'water_genasi': 'Water Genasi', 'yuan_ti': 'Yuan-ti', 'kender': 'Kender', 'other': 'Error'})}";

  static String m20(amount) => "${amount} Spells";

  static String m21(name) =>
      "Are you sure that you want to delete the spell ***${name}***?\nIt is not possible to revert this decision.";

  static String m22(numberDice, typeDie) => "${numberDice}D${typeDie}";

  static String m23(typeDie) => "D${typeDie}";

  static String m24(condition) => "Until the spell is ${condition}";
  ...
  static String m28(status) =>
      "${Intl.select(status, {'concentration': 'Concentration', 'surprised': 'Surprised', 'other': 'Error'})}";

  static String m29(visibility) =>
      "${Intl.select(visibility, {'lightly_obscured': 'lightly obscured', 'heavily_obscured': 'heavily obscured', 'other': 'Error'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "bonusAction": m2,
    "characterAddTitle": MessageLookupByLibrary.simpleMessage("Add Character"),
    "characterClass": MessageLookupByLibrary.simpleMessage(
      "Class of Character",
    ),
    "characterDeleteMessage": m3,
    "characterDeleteOk": MessageLookupByLibrary.simpleMessage("Delete"),
    "characterDeleteTitle": MessageLookupByLibrary.simpleMessage(
      "Delete Character",
    ),
    "characterEditTitle": MessageLookupByLibrary.simpleMessage(
      "Edit Character",
    ),
    "characterName": MessageLookupByLibrary.simpleMessage("Name of Character"),
    ...
    "difficultTerrain": MessageLookupByLibrary.simpleMessage(
      "difficult terrain",
    ),
    ...
    "dosi": MessageLookupByLibrary.simpleMessage("Dragons of Stormwreck Isle"),
    ...
    "mainScreenSpellBooks": MessageLookupByLibrary.simpleMessage("Characters"),
    "mainScreenSpellList": MessageLookupByLibrary.simpleMessage("Spell-List"),
    "material": MessageLookupByLibrary.simpleMessage("Material"),
    "medium": MessageLookupByLibrary.simpleMessage("medium"),
    "meleeWeaponAttacks": MessageLookupByLibrary.simpleMessage(
    ...
    "naturalAttacks": MessageLookupByLibrary.simpleMessage("Natural Attacks"),
    "necromancy": MessageLookupByLibrary.simpleMessage("Necromancy"),
    "necrotic": MessageLookupByLibrary.simpleMessage("Necrotic"),
    "onHigherLevels": MessageLookupByLibrary.simpleMessage("At Higher Levels"),
    "oneHandedMeleeAttacks": MessageLookupByLibrary.simpleMessage(
    ...
    "phb": MessageLookupByLibrary.simpleMessage("Player\'s Handbook (2014)"),
    "piercing": MessageLookupByLibrary.simpleMessage("Piercing"),
    "poison": MessageLookupByLibrary.simpleMessage("Poison"),
    "pota": MessageLookupByLibrary.simpleMessage("Princes of the Apocalypse"),
    ...
    "settingsDeleteData": MessageLookupByLibrary.simpleMessage(
      "Delete App-Data",
    ),
    "settingsDistanceType": MessageLookupByLibrary.simpleMessage("Select Unit"),
    "settingsDoNotShowMessageAgain": MessageLookupByLibrary.simpleMessage(
      "Do not show this message again",
    ),
    "settingsExportData": MessageLookupByLibrary.simpleMessage(
      "Export App-Data",
    ),
    "settingsExportMessage": MessageLookupByLibrary.simpleMessage(
      "Data will be exported to the downloads folder",
    ),
    "settingsExportMessageFail": MessageLookupByLibrary.simpleMessage(
      "Error: Export was not possible, check permissions",
    ),
    "settingsExportMessageSuccess": MessageLookupByLibrary.simpleMessage(
      "Data successfully exported to downloads",
    ),
    "settingsImport5e": MessageLookupByLibrary.simpleMessage(
      "Import 5e Spells",
    ),
    "settingsImportData": MessageLookupByLibrary.simpleMessage(
      "Import App-Data",
    ),
    ...
    "settingsLanguageLabel": MessageLookupByLibrary.simpleMessage(
      "Select Language",
    ),
    ...
    "species": m19,
    "spellBookSearchCharacter": MessageLookupByLibrary.simpleMessage(
      "Search Character",
    ),
    ...
    "spellDetailAddSpellTitle": MessageLookupByLibrary.simpleMessage(
      "Add to Character",
    ),
    "spellDetailCastTime": MessageLookupByLibrary.simpleMessage("Casting Time"),
    "spellDetailClasses": MessageLookupByLibrary.simpleMessage("Classes"),
    "spellDetailComponents": MessageLookupByLibrary.simpleMessage("Components"),
    "spellDetailDeleteMessage": m21,
    "spellDetailDeleteTitle": MessageLookupByLibrary.simpleMessage(
      "Delete Spell",
    ),
    "spellDetailDice": m22,
    "spellDetailDie": m23,
    ...
    "spellDetailRemoveFromCharTitle": MessageLookupByLibrary.simpleMessage(
      "Remove from Character",
    ),
    "spellLevel": m26,
    "spellSchoolLevel": m27,
    "srd": MessageLookupByLibrary.simpleMessage("Systems Reference Document"),
    "status": m28,
    "tcoe": MessageLookupByLibrary.simpleMessage(
      "Tasha\'s Cauldron of Everything",
    ),
    "thrownWeaponAttacks": MessageLookupByLibrary.simpleMessage(
    ...
    "unarmedAttacks": MessageLookupByLibrary.simpleMessage("Unarmed attacks"),
    ...
    "xphb": MessageLookupByLibrary.simpleMessage("Player\'s Handbook (2024)"),
  };
}
